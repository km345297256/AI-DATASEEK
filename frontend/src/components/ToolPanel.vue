<template>
  <div
    ...
    <div class="h-full" :style="{ 'width': isShow ? '100%' : '0px' }">
      <ToolPanelContent v-if="isShow && toolContent" :key="toolPanelContentKey" :sessionId="sessionId" :realTime="realTime" :toolContent="toolContent" :live="live" :isShare="isShare" @hide="hideToolPanel" @jumpToRealTime="jumpToRealTime" />
    </div>
  </div>
</template>
...
const toolPanelContentKey = computed(() => {
