...
class ShellWaitResult(BaseModel):
    ...
    status: Literal["running", "completed"] = Field(..., description="Process state after waiting")
    returncode: Optional[int] = Field(None, description="Process return code when completed")
