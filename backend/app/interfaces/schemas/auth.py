...
from app.domain.models.user import UserRole, RegistrationStatus
...
class RegisterResponse(BaseModel):
    ...
    message: str = "Registration submitted. Please wait for administrator approval before logging in."
